    ...
    public partial class Four : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrackInPlaylists", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TrackInPlaylists_Playlists_UserPlaylistId",
                        column: x => x.UserPlaylistId,
                        principalTable: "Playlists",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TrackInPlaylists_Tracks_TrackId",
                        column: x => x.TrackId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrackInPlaylists_TrackId",
                table: "TrackInPlaylists",
                column: "TrackId");

            migrationBuilder.CreateIndex(
                name: "IX_TrackInPlaylists_UserPlaylistId",
                table: "TrackInPlaylists",
